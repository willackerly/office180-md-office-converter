#!/usr/bin/env python3
"""Create a Vector180 deck from the skill's registered-runtime starter."""
...
STARTER_TITLE = "Minimal Vector180 deck"
...
def main() -> int:
    ...
    if [suffix.lower() for suffix in output.suffixes[-2:]] != [
        ...
        raise SystemExit("output must end in .vector180.html")
    if output.exists():
    ...
    starter = Path(__file__).parent.parent / "assets" / "starter.vector180.html"
