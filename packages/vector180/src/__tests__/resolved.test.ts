...
const DIRECT_SUBTITLE = `    <text id="cover.subtitle" class="cover-subtitle"
          data-vector180-role="text" data-vector180-export="native"
          data-vector180-frame="125 445 1350 80"
          data-vector180-line-step="41"
          x="125" y="490">Manifest first. Slides declarative. Theme last.</text>`;

async function resolveSource(
  mutate: (source: string) => string = (source) => source,
): Promise<Vector180ResolvedDeckResult> {
  const source = mutate(await readMinimalDeck());
  const deck = await loadDeck({
    kind: "text",
    text: source,
    name: "resolved.vector180.html",
  });
  return resolveVector180Deck(deck);
}
...
function findObject(
  ...
  id: string,
): Vector180ResolvedObject | undefined {
...
describe("C6 resolved Vector180 model", () => {
  it("resolves the conforming fixture to immutable JSON-safe canvas and objects", async () => {
    ...
    const result = resolveVector180Deck(deck);
    ...
    expect(title).toMatchObject({
      ...
      lineStep: 116,
      anchor: "start",
      lines: [{ text: "Minimal Vector180 deck", x: 120, y: 410 }],
      wrap: "none",
      autofit: "none",
  ...
  it("normalizes primitives, nested translations, unions, order, and opaque assets", async () => {
    const markup = `    <g id="cover.translated"
       data-vector180-role="group" data-vector180-export="native"
       transform="translate(100, 40)">
      <circle id="cover.translated.circle"
              data-vector180-role="shape" data-vector180-export="native"
              cx="20" cy="30" r="10"/>
      ...
      <g id="cover.translated.art"
         ...
         data-vector180-bounds="-20 0 10 10">
        <path d="M0 0 L10 10"/>
      </g>
      <path id="cover.translated.ignored"
            data-vector180-role="shape" data-vector180-export="ignore"
            d="M0 0 L100 100"/>
    </g>`;
    ...
    const result = await resolveSource((source) =>
      replaceSubtitle(
        ...
        `    <text id="cover.subtitle" class="cover-subtitle"
          data-vector180-role="text" data-vector180-export="native"
          data-vector180-frame="125 0 1350 1"
          data-vector180-line-step=".2">
    ...
    const result = await resolveSource((source) =>
      replaceSubtitle(
        ...
        `    <text id="cover.subtitle" class="cover-subtitle"
          data-vector180-role="text" data-vector180-export="native"
          data-vector180-frame="125 0 1350 1"
          data-vector180-line-step="${paddedStep}">
      <tspan x="125" y=".1">First</tspan>
      <tspan x="125" y=".3">Second</tspan>
    </text>`,
      ),
  ...
  it("normalizes negative zero before producing JSON-safe geometry", async () => {
    const result = await resolveSource((source) =>
      replaceRequired(
        ...
        'data-vector180-frame="120 280 1360 160"\n          data-vector180-line-step="116"\n          x="120" y="410"',
        'data-vector180-frame="-0 280 1360 160"\n          data-vector180-line-step="116"\n          x="-0" y="410"',
      ),
    );
  ...
  it.each([
    ...
    },
    {
      ...
      code: "VECTOR180-PROFILE-GEOMETRY",
      mutate: (source: string) =>
        replaceRequired(
          source,
    ...
    },
    {
      ...
      mutate: (source: string) =>
        replaceRequired(
          source,
          'data-vector180-to="architecture.node.policy"',
          'data-vector180-to="architecture.node.missing"',
        ),
    },
    {
      name: "a C4-supported polyline",
      code: "VECTOR180-PROFILE-OBJECT-KIND",
      mutate: (source: string) =>
        replaceRequired(
          source,
    ...
    },
    {
      ...
      mutate: (source: string) =>
        insertBeforeCoverTitle(
          source,
          `    <g id="cover.empty"
       data-vector180-role="group" data-vector180-export="native"></g>`,
        ),
    },
  ...
  it.each([
    {
      ...
      mutate: (source: string) =>
        replaceRequired(
          source,
          'data-vector180-role="group" data-vector180-export="native">',
          'data-vector180-role="group" data-vector180-export="native" transform="rotate(5)">',
        ),
    },
    {
    ...
    },
    {
      ...
      mutate: (source: string) =>
        replaceRequired(
          source,
          'data-vector180-role="group" data-vector180-export="native">',
          'data-vector180-role="group" data-vector180-export="native" transform="translate(1 2) scale(2)">',
        ),
    },
  ...
  it.each([
    {
      ...
      code: "VECTOR180-PROFILE-TEXT-FRAME",
      mutate: (source: string) =>
        replaceRequired(
          source,
          '          data-vector180-frame="125 445 1350 80"\n',
    ...
    },
    {
      ...
      mutate: (source: string) =>
        replaceRequired(
          source,
          'data-vector180-line-step="41"',
          'data-vector180-line-step="41px"',
        ),
    },
    {
      name: "a decoded direct newline",
      code: "VECTOR180-PROFILE-TEXT-LINES",
      mutate: (source: string) =>
        replaceRequired(
          source,
  ...
  it.each([
    {
      ...
      code: "VECTOR180-PROFILE-ASSET-BOUNDS",
      markup: `    <g id="cover.art"
       data-vector180-role="asset" data-vector180-export="svg"><path d="M0 0"/></g>`,
    },
    {
      ...
      markup: `    <g id="cover.art"
       data-vector180-role="asset" data-vector180-export="svg"
       data-vector180-bounds="0,0,10,10"><path d="M0 0"/></g>`,
    },
    {
      name: "a transformed SVG boundary",
      code: "VECTOR180-PROFILE-TRANSFORM",
      markup: `    <g id="cover.art"
       data-vector180-role="asset" data-vector180-export="svg"
       data-vector180-bounds="0 0 10 10" transform="translate(1 2)"></g>`,
    },
    {
      name: "a raster requiring a resource fetch",
      code: "VECTOR180-PROFILE-RESOURCE",
      markup: `    <image id="cover.photo"
       data-vector180-role="asset" data-vector180-export="raster"
       data-vector180-bounds="0 0 10 10" href="#photo"/>`,
    },
  ...
  it("retains invalid C4 diagnostics and rejects partial materialization", async () => {
    ...
    const partial = resolveVector180Deck(partialDeck);
