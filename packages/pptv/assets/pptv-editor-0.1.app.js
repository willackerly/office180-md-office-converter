...
(() => {
  ...
  function identifySourceKind(name, source) {
    ...
    const byContent = trimmed.startsWith("<!doctype html") || trimmed.startsWith("<html") ? "html" : trimmed.startsWith("<svg") ? "svg" : trimmed.startsWith("{") ? "manifest" : "unknown";
  ...
  function serializeResolvedStyle(style) {
    return [
      ...
      ...style.fontFamily === void 0 ? [] : [`font-family:${style.fontFamily}`],
