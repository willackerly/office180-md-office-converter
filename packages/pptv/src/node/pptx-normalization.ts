...
interface OptionalPart {
  ...
  readonly ruleId:
    "pptv-c10/view-properties-inert/1" | "pptv-c10/table-styles-inert/1";
}
  ...
  for (const name of semanticPartNames) {
    ...
    if (name === "[Content_Types].xml") {
      ...
      if (name === "docProps/app.xml" || name === "docProps/core.xml") {
        applied.push({
          ruleId: "pptv-c10/generated-metadata/1",
          partName: name,
          occurrenceCount: 1,
          semanticScope: "non-authoritative-metadata",
          message:
            "Generated Office metadata is recorded but is not canonical PPTV source authority.",
          predicates: Object.freeze([
            {
...
function normalizedContentTypes(
  ...
  const overrides = [...inspected.overrides.entries()]
    ...
    .sort(entryCompare);
  applied.push({
    ruleId: "pptv-c10/content-type-set/1",
...
function normalizedRelationships(
  ...
  const relationships = inspectRelationships(relationshipPartName, root)
    ...
    .sort(compareText);
  applied.push({
    ruleId: "pptv-c10/relationship-graph/1",
...
function replaceRelationshipReferences(
  ...
  if (count === 0) return;
  applied.push({
    ruleId: "pptv-c10/relationship-reference/1",
    partName,
...
function normalizeSlideSize(
  ...
  applied.push({
    ruleId: "pptv-c10/slide-size-preset-omitted/1",
    partName,
    occurrenceCount: 1,
    semanticScope: "current-slide-content",
    message:
...
function normalizeRootZeroGroupTransform(
  ...
  properties.children = [];
  applied.push({
    ruleId: "pptv-c10/root-zero-group-transform/1",
    partName,
    occurrenceCount: 1,
    semanticScope: "current-slide-content",
    message:
...
function normalizeThemeDefaults(
  ...
  applied.push({
    ruleId: "pptv-c10/theme-empty-defaults/1",
    partName,
...
function normalizePresentationDefaults(
  ...
  root.children = [];
  applied.push({
    ruleId: "pptv-c10/presentation-property-defaults/1",
    partName,
    occurrenceCount: 3,
    semanticScope: "current-slide-content",
    message:
