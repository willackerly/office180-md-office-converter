...
export interface PptvResolvedStyle {
...
export interface PptvStyleProvenance {
  readonly fill: PptvResolvedPropertyProvenance;
  readonly stroke: PptvResolvedPropertyProvenance;
  readonly strokeWidth: PptvResolvedPropertyProvenance;
  readonly opacity: PptvResolvedPropertyProvenance;
  readonly fontFamily?: PptvResolvedPropertyProvenance;
  readonly fontSize?: PptvResolvedPropertyProvenance;
  readonly fontWeight: PptvResolvedPropertyProvenance;
  readonly fontStyle: PptvResolvedPropertyProvenance;
  readonly textAnchor: PptvResolvedPropertyProvenance;
}

export interface PptvResolvedObjectStyle {
  readonly style: PptvResolvedStyle;
  readonly styleProvenance: PptvStyleProvenance;
}

export interface PptvStyleResolution {
...
interface StyleCandidate {
  ...
  readonly provenance: PptvResolvedPropertyProvenance;
}
...
const TOKEN_PATTERN = /^--pptv-[A-Za-z0-9_-]+$/u;
...
const VAR_PATTERN = /^var\(\s*(--pptv-[A-Za-z0-9_-]+)\s*\)$/u;
    ...
    diagnostics.push(
      makeDiagnostic(
        ...
        deck.activeTheme === undefined
          ? "PPTV style resolution requires one active theme."
...
function resolveNodes(
  ...
  styles: Map<string, PptvResolvedObjectStyle>,
  diagnostics: Diagnostic[],
): void {
