...
`esbuild@0.28.1` as an ES2022 IIFE. Its registered size is 659,260 bytes and
its SHA-256 is
...
standalone profile. The four-test matrix passed in Chromium 151.0.7922.34,
Firefox 153.0, and WebKit 26.5 on 2026-07-30: 12 of 12 project/test results.
